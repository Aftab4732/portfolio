                    ...
                    transition={{duration:1}}className="w-full lg:w-1/4">
                        ...
                        transition={{duration:1}} className="w-full max-w-xl lg:w-3/4">
                            <h6 className="mb-2 font-semibold">
                                {experience.role} - <span className="text-sm text-slate-700">
                                    {experience.company}
                                </span>
                            </h6>
                            <p className="py-4 ">{experience.description}</p>
                            {experience.technologies.map((tech,index)=>(
                            <span key={index} className="mt-5 mr-2 rounded bg-slate-900 px-2 py-1 text-sm text-red-100 hover:italic">{tech}</span>
                            )
                            )
                            }
                        </motion.div>
